// Fungsi utama untuk mengambil berita gaya dan menampilkannya di halaman
const get = async () => {
    try {
        // Mengambil data berita gaya dari API
        const response = await fetch("https://api-berita-indonesia.vercel.app/tempo/gaya");
...
// Memanggil fungsi get untuk mengambil berita gaya dan menampilkannya saat halaman dimuat
get();
