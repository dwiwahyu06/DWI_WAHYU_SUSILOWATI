// Fungsi utama untuk mengambil berita dan menampilkannya di halaman
const get = async () => {
    try {
        // Mengambil data dari API berita
        const response = await fetch("https://api-berita-indonesia.vercel.app/tempo/dunia");
        ...
        result.data.posts.slice(0, 21).forEach((article) => {
            ...
            image.classList.add("images"); // Menambahkan class 'images' untuk styling
...
// Memanggil fungsi get untuk mengambil berita dan menampilkannya saat halaman dimuat
get();
