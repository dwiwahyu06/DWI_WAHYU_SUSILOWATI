// Fungsi untuk mengambil data berita dari API dan menampilkannya di halaman
const get = async () => {
    try {
        // Mengambil data dari API berita
        const response = await fetch("https://api-berita-indonesia.vercel.app/tempo/tekno/");
        ...
        // Menampilkan pesan kesalahan di container berita
        const newsContainer = document.getElementById('news-content');
